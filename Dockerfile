...
RUN apk update && apk upgrade && apk add --no-cache \
    ...
    file autoconf make gcc g++ imagemagick-dev libtool libzip-dev libxml2-dev oniguruma-dev \
...
# Workarround for preloadable_libiconv which istn includet anymore in gnu-libiconv
